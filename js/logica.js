...
$(document).ready(function() {
  var startDate, endDate; // Variables para almacenar el rango de fechas seleccionado
  ...
  // Configuración del Datepicker de jQuery UI en español
  ...
  $('#saveEvent').click(function() {
    ...
    if (title && start && end) {
      ...
      // Limpiar los campos y ocultar el modal
      $('#title').val('');
      $('#start').val('');
      $('#end').val('');
